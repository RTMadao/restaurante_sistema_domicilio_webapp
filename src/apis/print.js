export function printSection (el, binding) {
  ...
  el.addEventListener('click', () => {
    ...
    style.appendChild(document.createTextNode(`@page{size:300px ${elemToPrint.offsetHeight - 100}px}`))
    if (elemToPrint) {
